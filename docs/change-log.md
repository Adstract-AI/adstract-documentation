...
- New acknowledgment-specific exceptions for known failure cases:
...
- New `PromptRejectedError` exception for rejected prompts.
- New `NoFillError` exception for no-fill outcomes.
